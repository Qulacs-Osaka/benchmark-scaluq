...
libs = ["scaluq", "qulacs", "custatevec", "qiskit-aer", "pennylane-lightning-gpu", "pennylane-lightning-kokkos"]
libnames = ["Scaluq", "Qulacs", "cuStateVec", "Qiskit-Aer", "Lightning-GPU", "Lightning-Kokkos"]
markers = ['P', 'o', '^', 's', 'D', 'X']
colors = ['tab:red', 'tab:blue', 'tab:gray', "tab:green", "tab:purple", "tab:orange"]
only_f64 = True
